...
export const metadata: Metadata = {
  title: "Entity Structuring | Ironvael",
  description:
...
export default function EntityStructuringPage() {
  return (
    <CapabilityPageLayout
      ...
      heroImage="/entity-formation-hero.jpg"
      ...
      body={[
        ...
        "Our entity structuring practice combines structural design with operational reality. We work alongside legal and tax advisors to ensure structures are not only legally sound but practically executable—with clear governance, defined service relationships, and manageable compliance burdens.",
